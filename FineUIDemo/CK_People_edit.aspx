<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CK_People_edit.aspx.cs"
    Inherits="FineUIDemo.CK_People_edit" %>
    ...
    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            <x:TextBox ID="tbxName" runat="server" Label="名称" Required="true" ShowRedStar="true">
             ...
             <x:TextBox ID="tbxPhoneNo" runat="server" Label="电话" Required="true" ShowRedStar="true">
            </x:TextBox>
            <x:TextBox ID="tbxNote" runat="server" Label="备注" Required="true" ShowRedStar="true">
            </x:TextBox>
        </Items>
    </x:SimpleForm>
    </form>
