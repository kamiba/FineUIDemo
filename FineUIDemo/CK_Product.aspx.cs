...
namespace FineUIDemo
{
    public partial class Product : Page
    {
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("~/CK_Product_new.aspx", "新增产品");
        ...
        private void BindGrid()
        {
            ...
            ds = m_bllCK_Product.GetList(strWhere);
            // 在查询添加之后，排序和分页之前获取总记录数
            // Grid1总共有多少条记录
            Grid1.RecordCount = ds.Tables[0].Rows.Count;

            ds = m_bllCK_Product.GetList(Grid1.PageSize, Grid1.PageIndex + 1, strWhere);
