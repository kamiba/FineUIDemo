<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CK_SendGoods_edit.aspx.cs"
    Inherits="FineUIDemo.CK_SendGoods_edit" %>
...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <x:DropDownList runat="server" ID="DropDownListPeople" Label="送货人" AutoPostBack="true">
            </x:DropDownList>
            <x:TextBox ID="tbxCount" runat="server" Label="数量" Required="true" ShowRedStar="true">
            </x:TextBox>
            <x:DatePicker runat="server" Required="true" Label="送货日期" EmptyText="请选择送货日期"
